...
export default function WeatherPage() {
    ...
    return (
        <div className="w-full h-full justify-center p-15 max-[480px]:p-1.5 max-[323px]:p-0 min-[768px]:p-5 max-[1024px]:p-5 bg-(--main-background) max-[325px]:max-w-[320px] max-[380px]:max-w-[370px] max-[430px]:max-w-[425px]" suppressHydrationWarning>
