...
export default function Project() {
  return (
    <section id="projects" className="max-[321px]:w-[320px]">
      <div className="container">
        ...
        <div className="grid grid-cols-(--project-grid-cols) md:grid-cols-(--md-project-grid-cols) md:p-5 mt-10 gap-10 max-[321px]:grid-cols-(--sm-project-grid-cols)">
          <ProjectCard
